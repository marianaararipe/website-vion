    ...
    <footer className="py-5 sm:px-10 px-5">
      <div className="screen-max-width">
        ...
        <div className="flex md:flex-row flex-col md:items-center justify-between">
          <p className="font-semibold text-gray text-xs">Error 504 @ 2025 | Vion - Desafio dos Dados.</p>
            ...
            {footerLinks.map((link, i) => (
              <React.Fragment key={link}>
                <a 
                  ...
                  className="font-semibold text-gray text-xs hover:text-white transition-colors duration-200 cursor-pointer"
                >
                  {link}
                </a>
                {i !== footerLinks.length - 1 && (
                  <span className="mx-2 text-gray text-xs"> | </span>
                )}
              </React.Fragment>
            ))}
          </div>
